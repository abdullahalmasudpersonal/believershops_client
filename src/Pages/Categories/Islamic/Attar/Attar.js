...
const Attar = ({ attar }) => {
    ...
    return (
        <div className='product-dev'>
            ...
            <p className='text-center product-dev-p'>
                {
                    offerPrice ?
                        ...
                        <p>
                            ...
                            {/* <span className='text-secondary' style={{ textDecoration: 'line-through 2px' }}>{ragularPrice}</span> */}
                        </p>
            ...
            {/*  <p className='text-center product-dev-p'>
                    <span style={{ fontSize: '17px', fontFamily: "Optima", fontWeight: 'bold' }}>৳</span>
                    <span>{offerPrice}</span>

                    <span style={{ fontSize: '17px', fontFamily: "Optima", fontWeight: 'bold' }}> ৳</span>
                    <span>{ragularPrice}</span>
                </p> */}
            {/*    </div> */}
        </div>
