...
const ElectronicsCategories = () => {
    ...
    return (
        <div className='nestedProductsMain'>
             <PageTitle pageTitle='Electronics |' />
        <div className='nestedProductsBreadcrumb'>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 ">
                    ...
                    <li class="breadcrumb-item active">Electronices</li>
                </ol>
            </nav>
        </div>
        <div className='nestedProductsNamePart'>
            <div>
                <h5 className='m-0 fw-bold'>Electronices Products In Mahsez</h5>
            </div>
            <div>
        ...
        <div className='nestedProductsSortByViewPart'>
            <div>
                <p className='m-0'>{nestedProductsLength} Products Found In Electronices</p>
            </div>
